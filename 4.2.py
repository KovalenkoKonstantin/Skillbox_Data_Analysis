...
#
# Повторим задачу, разобранную в видео, и дополним её одной строчкой.
#
# Пользователь хочет купить курс и вводит состояние своего банковского счёта для проверки.
# Курс стоит 75 000 рублей. Если на счету хватает денег (больше или равно),
# то со счёта списываются 75 000 рублей, и программа выводит сообщение об успешной покупке.
...
#
# Напишите программу из видео, которая запрашивает число у пользователя (у сына),
