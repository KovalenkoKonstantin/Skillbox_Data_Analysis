...
#
# Математик Паша недавно заметил,
# что у него уже есть куча разных таблиц степеней,
# но нет самого основного — таблицы умножения.
# Пора бы это исправить.

# Напишите программу,
# которая выводит таблицу умножения для чисел от 1 до 9.
# Для этого используйте конструкцию вложенного цикла:
# внешний отвечает за первый множитель, а внутренний — за второй.

# Дополнение: выведите настоящую таблицу умножения,
# без всяких знаков, только числа. Чтобы она получилась красивой и ровной,
# используйте литерал \t внутри оператора end.
...
# и выводит таблицу суммы для чисел от 1 до N.
#
# Пример:
