...
#
# Нужно помочь бухгалтерам:
# напишите функцию, на вход которой подаются два числа
# — общая сумма налога tax и новый налог new_tax,
# который нужно добавить к общей сумме.
...
#
# Напишите функцию eqv,
# которая принимает три числа и затем сравнивает сумму первых двух чисел с третьим
# с определённой степенью точности:
# до 15-го знака после точки.
