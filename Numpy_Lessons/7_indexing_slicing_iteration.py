...
b = a[2:4] # срезы не создают новые массивы, но возвращают представление
b
# array([2, 3])
b[0] = -100
b
...
a[4::2] = np.array([10, 20, 30, 40]) # срезу можно присваивать массив
a
...
# 10 20 30
# 100 200 300
for val in x.flat:  # flat все элементы многомерного массива выстраивает в вектор
    print(val, end=' ')
...
a
# array([0, 1, 2, 3, 4, 5, 6])
a[[0, 4, 6]] = [-1, -2, -3]  # замена значений элементов массива по индексам
a
# array([-1,  1,  2,  3, -2,  5, -3])
