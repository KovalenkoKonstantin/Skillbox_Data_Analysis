...
# Разумеется, в почтовом извещении ему нужно было написать свои фамилию,
# имя и адрес проживания, чтобы кто-нибудь не получил посылку за него,
# например члены его семьи (а им бы хотелось!).
#
# Напишите функцию для вывода фамилии,
# имени и адреса для конкретного члена семьи.
