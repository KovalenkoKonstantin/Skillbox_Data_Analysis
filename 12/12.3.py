# Задача 1. Вода
#
# Одна бутылка воды «КлирВотер» от производителя «ВодЗавод»
# в разных магазинах стоит по-разному.
#
# Напишите программу,
# которая три раза вызывает функцию
# aboutWater, передаёт в неё один аргумент — цену на воду
...
# (вещественное число) и вызывает функции
# sphereArea и sphereVolume.
