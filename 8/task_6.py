...
# чтобы можно было прожить учебный год (десять месяцев),
...
for month in range(1, 11):
    lacks += expenses - educational_grant
    print(f'{month}. месяц траты {round(expenses, 2)} не хватает {round(lacks, 2)}')
    expenses *= 1.03
print()
print(f'Нужно попросить у родителей {round(lacks, 2)} рублей')
