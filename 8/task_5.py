...
# о функциях математики.
# Помогите Саше написать программу,
# которая будет считать значение функции в каждой точке отрезка с нужным шагом,
# начиная с конца).
# Напишите программу,
# которая получает на вход начало и конец отрезка,
# а также шаг (отрицательный),
# а затем высчитывает функцию y в каждой точке отрезка
...
# В точке -2 функция равна 9
stop = int(input('Введите начало отрезка: '))
start = int(input('Введите конец отрезка: '))
