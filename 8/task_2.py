# «МирПрогБанк» наконец-то разделил законопослушных граждан
# и должников и поместил их в разные базы.
...
# Напишите программу,
# которая получает данные о количестве должников,
# а затем спрашивает у каждого пятого
# (начиная с нуля)
...
for debtor in range(0, debtors, 5):
    ...
    personal_debt = int(input('Сколько должны? '))
    total_debt +=personal_debt
